...
def plot_labeled_bubble(df, output_folder='output', top_n=15):
    ...
    ax.set_xlim(1.3, data['score'].max() * 1.2)
    ...
    output_path = os.path.join(output_folder, 'food source.png')
    plt.tight_layout()
...
if __name__ == "__main__":
    try:
        ...
        print(f"Error: No write permission to create output directory {output_dir}")
